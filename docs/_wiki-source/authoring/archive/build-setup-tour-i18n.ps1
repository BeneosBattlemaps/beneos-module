...
#
# ARCHIVED (2026-07-04): one-shot migration, already executed. The Setup Tour
# keys were translated into all 13 languages by the localization wave. Running
# this script again would overwrite those translations with English in every
# non-en lang file. Kept for reference only. Do not run.
#
