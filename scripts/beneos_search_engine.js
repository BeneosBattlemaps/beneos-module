...
export class BeneosDatabaseHolder {
  ...
  static async #loadOneDb(url, prop, store, opts = {}) {
    ...
    const useCache = () => {
      ...
      // and the i18n matrix — a purely cosmetic tag-translation table loaded
      // without any notification — could put the entire cloud window offline
      // for a whole session without printing a single line anywhere.
