...
export class BeneosCloudWindowV2 extends HandlebarsApplicationMixin(ApplicationV2) {
  ...
  #releaseIsOrphan(props) {
    ...
    if (!dir) return false
    // ABWEICHUNG ZU main, mit Absicht: dieser Zweig fuehrt neben dem exakten
    // Index einen Kernindex, und #releaseFor faellt darauf zurueck. Wer hier
    // nur exakt nachschlaegt, erklaert jede Karte mit der anderen
    // Schreibweise fuer verwaist und blendet sie aus, obwohl sie
    // installierbar ist. Gemessen auf main: 144 Schluessel, 144 eindeutige
    // Kerne, 36 von 36 Mitgliedern treffen ueber den Kern.
    return !this.#releaseFor(dir)
  }
